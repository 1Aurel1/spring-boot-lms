...
import com.aurel.lms.service.dto.response.ExceptionResponse;
...
public class RestControllerExceptionHandler {
    ...
    @ResponseBody
    @ResponseStatus(HttpStatus.BAD_REQUEST)
    public ResponseEntity<?> resolveException(BadRequestException ex){
        ...
        return new ResponseEntity<>(new ApiResponse(ARConstants.error, data), HttpStatus.BAD_REQUEST);
    }
}
